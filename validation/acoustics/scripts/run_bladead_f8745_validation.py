...
def evaluate_f8745(source_velocity_scale=1.0, return_components=False):
    ...
    outputs = RotorAnalysisOutputs(
        ...
        sectional_thrust=_variable(num_blades * thrust),
        sectional_torque=_variable(num_blades * torque),
        sectional_drag=_variable(num_blades * torque / radius),
...
def compare_to_experiment(prediction):
