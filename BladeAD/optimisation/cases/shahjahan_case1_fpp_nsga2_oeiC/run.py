...
project's solves silently auto-background, see the project CLAUDE.md).
    ...
    conda run -n rotor_design python -u \
      999-software/bladead_repo/BladeAD/optimisation/cases/shahjahan_case1_fpp_nsga2_oeiC/run.py \
      > 999-software/bladead_repo/BladeAD/optimisation/cases/shahjahan_case1_fpp_nsga2_oeiC/run.log 2>&1
"""
import os
import sys
import time
