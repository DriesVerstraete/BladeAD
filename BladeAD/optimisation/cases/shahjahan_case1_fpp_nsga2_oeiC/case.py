"""Shahjahan Case 1 (FPP) -- NSGA-II population-method arm, OEI pair C
(cruise electrical power vs OEI thrust margin).
...
# OEI pair C: cruise electrical power (min) vs OEI thrust margin (max).
...
CASE["nsga2"] = dict(CASE["nsga2"], save_tag="oeiC_run1", hot_start=False)
